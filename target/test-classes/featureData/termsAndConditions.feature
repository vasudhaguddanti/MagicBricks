...
Scenario: Validate that the user able to navigate the terms and conditions from Premium Homes Page
...
And user should be able to click on terms and conditions link
